...
function YoutubeContent() {
    ...
    const youtubeContent = data?.content?.filter((content: Content) => content.type === "youtube") || [];
  return (
    <>
        <DeleteModal />

        <div className='grid grid-cols-10 max-w-350 mx-auto'>
          ...
          <div className="bg-bg-content px-8 py-7 col-span-8">
            <div className='flex justify-between items-center pb-9'>
              <div className={cn(textVariants({variant: "h1"}))}>YouTube Content</div>
            </div>
